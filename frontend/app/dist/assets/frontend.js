...
;define("frontend/adapters/application", ["exports", "@ember-data/adapter/json-api"], function (_exports, _jsonApi) {
  ...
  class ApplicationAdapter extends _jsonApi.default {
    ...
    } // Altere para o namespace correto se necessário
  }
...
;define("frontend/controllers/posts", ["exports", "@ember/controller", "@glimmer/tracking", "@ember/object"], function (_exports, _controller, _tracking, _object) {
  "use strict";
  ...
  let PostsController = _exports.default = (_class = class PostsController extends _controller.default {
    constructor() {
      super(...arguments);
      _initializerDefineProperty(this, "posts", _descriptor, this);
      _initializerDefineProperty(this, "newPostTitle", _descriptor2, this);
      _initializerDefineProperty(this, "newPostContent", _descriptor3, this);
      this.loadPosts();
    }
    async loadPosts() {
    ...
    async createPost(event) {
      ...
      let data = await response.json();
      this.posts = [...this.posts, data]; // Atualiza a lista de posts
      this.newPostTitle = '';
      this.newPostContent = '';
    }
    async deletePost(postId) {
      ...
      this.loadPosts(); // Recarrega os posts após exclusão
    }
  }, _descriptor = _applyDecoratedDescriptor(_class.prototype, "posts", [_tracking.tracked], {
    configurable: true,
    enumerable: true,
    writable: true,
  ...
  }), _descriptor2 = _applyDecoratedDescriptor(_class.prototype, "newPostTitle", [_tracking.tracked], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: function () {
  ...
  }), _descriptor3 = _applyDecoratedDescriptor(_class.prototype, "newPostContent", [_tracking.tracked], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: function () {
  ...
  }), _applyDecoratedDescriptor(_class.prototype, "createPost", [_object.action], Object.getOwnPropertyDescriptor(_class.prototype, "createPost"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "deletePost", [_object.action], Object.getOwnPropertyDescriptor(_class.prototype, "deletePost"), _class.prototype), _class);
});
;define("frontend/data-adapter", ["exports", "@ember-data/debug/data-adapter"], function (_exports, _dataAdapter) {
  "use strict";
...
;define("frontend/initializers/ember-data", ["exports", "@ember-data/request-utils/deprecation-support"], function (_exports, _deprecationSupport) {
  "use strict";
...
;define("frontend/models/post", ["exports", "@ember-data/model"], function (_exports, _model) {
  "use strict";
  ...
  function _applyDecoratedDescriptor(i, e, r, n, l) { var a = {}; return Object.keys(n).forEach(function (i) { a[i] = n[i]; }), a.enumerable = !!a.enumerable, a.configurable = !!a.configurable, ("value" in a || a.initializer) && (a.writable = !0), a = r.slice().reverse().reduce(function (r, n) { return n(i, e, r) || r; }, a), l && void 0 !== a.initializer && (a.value = a.initializer ? a.initializer.call(l) : void 0, a.initializer = void 0), void 0 === a.initializer ? (Object.defineProperty(i, e, a), null) : a; }
  function _initializerWarningHelper(r, e) { throw Error("Decorating class property failed. Please ensure that transform-class-properties is enabled and runs after the decorators transform."); }
  let PostModel = _exports.default = (_dec = (0, _model.attr)('string'), _dec2 = (0, _model.attr)('string'), _dec3 = (0, _model.attr)('date'), _class = class PostModel extends _model.default {
    constructor(...args) {
      super(...args);
      _initializerDefineProperty(this, "title", _descriptor, this);
      _initializerDefineProperty(this, "content", _descriptor2, this);
      _initializerDefineProperty(this, "publishedAt", _descriptor3, this);
    }
    ...
    writable: true,
    initializer: null
  }), _descriptor3 = _applyDecoratedDescriptor(_class.prototype, "publishedAt", [_dec3], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: null
...
;define("frontend/router", ["exports", "@ember/routing/router", "frontend/config/environment"], function (_exports, _router, _environment) {
  ...
  Router.map(function () {
    this.route('posts', {
      path: '/'
    }); // Configura a rota 'posts' como a página inicial
    this.route('post', {
      path: '/posts/:post_id'
    });
  });
...
;define("frontend/routes/post", ["exports", "@ember/routing/route"], function (_exports, _route) {
  "use strict";
  ...
  class PostsRoute extends _route.default {
    async model() {
      let response = await fetch('http://localhost:3000/posts');
      return response.json(); // Retorna os posts que a aplicação Ember usará
    }
  }
...
;define("frontend/templates/application", ["exports", "@ember/template-factory"], function (_exports, _templateFactory) {
  ...
  */
  {
    "id": "U3E+uSws",
    "block": "[[[10,\"h1\"],[12],[1,\"Posts\"],[13],[1,\"\\n\"],[46,[28,[37,2],null,null],null,null,null]],[],false,[\"h1\",\"component\",\"-outlet\"]]",
    "moduleName": "frontend/templates/application.hbs",
    "isStrictMode": false
  });
});
;define("frontend/templates/posts", ["exports", "@ember/template-factory"], function (_exports, _templateFactory) {
  "use strict";
  ...
  <ul>
    {{#each this.model as |post|}}
      <li>
        ...
        <small>{{post.publishedAt}}</small><br>
        {{post.content}}<br>
        <button {{on "click" (fn this.deletePost post.id)}}>Excluir</button>
      </li>
    {{else}}
  ...
  <form {{on "submit" this.createPost}}>
    <input type="text" placeholder="Título" {{bind-attr value=this.newPostTitle}} />
    <textarea placeholder="Conteúdo" {{bind-attr value=this.newPostContent}}></textarea>
    <button type="submit">Criar Post</button>
  </form>
  */
  {
    "id": "mjUJe4o6",
    "block": "[[[10,\"h1\"],[12],[1,\"Posts\"],[13],[1,\"\\n\\n\"],[10,\"ul\"],[12],[1,\"\\n\"],[42,[28,[37,3],[[28,[37,3],[[30,0,[\"model\"]]],null]],null],null,[[[1,\"    \"],[10,\"li\"],[12],[1,\"\\n      \"],[10,\"strong\"],[12],[1,[30,1,[\"title\"]]],[13],[10,\"br\"],[12],[13],[1,\"\\n      \"],[10,\"small\"],[12],[1,[30,1,[\"publishedAt\"]]],[13],[10,\"br\"],[12],[13],[1,\"\\n      \"],[1,[30,1,[\"content\"]]],[10,\"br\"],[12],[13],[1,\"\\n      \"],[11,\"button\"],[4,[38,9],[\"click\",[28,[37,10],[[30,0,[\"deletePost\"]],[30,1,[\"id\"]]],null]],null],[12],[1,\"Excluir\"],[13],[1,\"\\n    \"],[13],[1,\"\\n\"]],[1]],[[[1,\"    \"],[10,2],[12],[1,\"Não há posts para exibir.\"],[13],[1,\"\\n\"]],[]]],[13],[1,\"\\n\\n\"],[11,\"form\"],[4,[38,9],[\"submit\",[30,0,[\"createPost\"]]],null],[12],[1,\"\\n  \"],[11,\"input\"],[24,\"placeholder\",\"Título\"],[24,4,\"text\"],[4,[38,14],null,[[\"value\"],[[30,0,[\"newPostTitle\"]]]]],[12],[13],[1,\"\\n  \"],[11,\"textarea\"],[24,\"placeholder\",\"Conteúdo\"],[4,[38,14],null,[[\"value\"],[[30,0,[\"newPostContent\"]]]]],[12],[13],[1,\"\\n  \"],[10,\"button\"],[14,4,\"submit\"],[12],[1,\"Criar Post\"],[13],[1,\"\\n\"],[13]],[\"post\"],false,[\"h1\",\"ul\",\"each\",\"-track-array\",\"li\",\"strong\",\"br\",\"small\",\"button\",\"on\",\"fn\",\"p\",\"form\",\"input\",\"bind-attr\",\"textarea\"]]",
    "moduleName": "frontend/templates/posts.hbs",
    "isStrictMode": false
  });
});
;define("frontend/transforms/boolean", ["exports", "@ember/debug", "@ember-data/serializer/transform"], function (_exports, _debug, _transform) {
  "use strict";
...
;define("frontend/transforms/date", ["exports", "@ember/debug", "@ember-data/serializer/transform"], function (_exports, _debug, _transform) {
  "use strict";
...
;define("frontend/transforms/number", ["exports", "@ember/debug", "@ember-data/serializer/transform"], function (_exports, _debug, _transform) {
  "use strict";
...
;define("frontend/transforms/string", ["exports", "@ember/debug", "@ember-data/serializer/transform"], function (_exports, _debug, _transform) {
  "use strict";
...
;
          if (!runningTests) {
            require("frontend/app")["default"].create({"name":"frontend","version":"0.0.0+cc90ac8a"});
          }
